...
$app->post('/register', function (){
    ...
    if (!isset($_POST['password']) || empty($_POST['password'])) {
        User::setErrorRegister("Preencha seu senha.");
        header("Location: /login");
        exit;
    }
...
// DADOS DO SEU CLIENTE
    ...
    $dadosboleto["endereco2"] = utf8_decode($order->getdescity()) . " - " . $order->getdesstate() . " - " . $order->getdescountry() . " - CEP: " .$order->getdeszipcode();
...
// SEUS DADOS
    $dadosboleto["identificacao"] = "Lads Store";
