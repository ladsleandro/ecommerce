...
<form method="post" target="pagseguro"
    ...
    <!-- Campos obrigatórios -->
    <input name="receiverEmail" type="hidden" value="leandro-alves25@hotmail.com">
    ...
    <input name="itemQuantity<?php echo htmlspecialchars( $counter1 + 1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" type="hidden" value="<?php echo htmlspecialchars( $value1["nrqtde"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
